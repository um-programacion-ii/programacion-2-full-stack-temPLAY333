...
```typescript
{
  ...
  // ⚠️ NO incluye campo "imagen" - solo disponible en EventoDetalleDTO
  eventoTipo: {
    id: number;
    nombre: string;
  };
...
**⚠️ Nota Importante**: Los eventos resumidos NO incluyen imagen para optimizar el tamaño de la respuesta. El Mobile muestra **iconos según tipo de evento** (música, deportes, teatro, etc.). Las imágenes reales solo están disponibles en el detalle del evento.
